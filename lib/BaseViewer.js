...
/**
 * The base viewer implementation.
 *
 * You must provide `options.modules` to this constructor function.
 *
 * @param {Object} options configuration options to pass to the viewer
 * @param {DOMElement} [options.container='body'] the container to render the viewer in, defaults to body.
...
function BaseViewer(options) {
  ...
  if (!(options && options.modules)) {
    throw new Error('must provide modeler components via options.modules');
  }

  this.options = options = assign({}, defaultOptions, options);
...
BaseViewer.prototype.importXML = function(xml, done) {
...
BaseViewer.prototype.createModdle = function() {
...
BaseViewer.prototype.get = function(name) {
...
BaseViewer.prototype.invoke = function(fn) {
...
BaseViewer.prototype.importDefinitions = function(definitions, done) {
...
BaseViewer.prototype._init = function(diagram) {
  initListeners(diagram, this.__listeners || []);
};

BaseViewer.prototype._createDiagram = function(options) {

  var modules = [].concat(options.modules, options.additionalModules || []);
...
/**
 * Remove all drawn elements from the BaseViewer.
 *
 ...
 */
BaseViewer.prototype.on = function(event, handler) {
  var diagram = this.diagram,
